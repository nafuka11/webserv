...
class TestResponseHeader:
    def test_server_header(self, http_connection: HTTPConnection):
        """Serverヘッダがあること"""
        http_connection.request("GET", "/")
        response = http_connection.getresponse()
        assert response.getheader("Server") == "webserv/1.0.0"

    def test_date_header(self, http_connection: HTTPConnection):
    ...
    def test_allow_header_one(self, http_connection: HTTPConnection):
...
class TestRequestHeader:
    def test_empty_header_value(self, http_connection: HTTPConnection):
        """ヘッダの値が空の時、400を返すこと"""
        headers = {"Empty": ""}
    ...
    def test_duplicate_host_header(self, http_connection: HTTPConnection):
    ...
    def test_missing_host_header(self, http_connection: HTTPConnection):
    ...
    def test_negative_content_length_header(self, http_connection: HTTPConnection):
    ...
    def test_non_digit_content_length_header(self, http_connection: HTTPConnection):
    ...
    def test_client_max_body_size_0(
        self, http_connection_factory: Callable[[int], HTTPConnection]
    ):
    ...
    def test_over_client_max_body_size(self, http_connection: HTTPConnection):
    ...
    def test_equal_client_max_body_size(self, http_connection: HTTPConnection):
    ...
    def test_content_length_and_transfer_encoding(
    ...
    def test_transfer_encoding_is_not_chunked(self, http_connection: HTTPConnection):
